 ...
 * <h4>Demo</h4>
App/WidgetService/Alarm Controller
 
<h4>Source files</h4>
<table class="LinkTable">
        <tr>
            <td class="LinkColumn">src/com.example.android.apis/app/AlarmController.java</td>
            <td class="DescrColumn">The activity that lets you scheduleBean alarms</td>
        </tr>
        <tr>
...
public class AlarmController extends Activity {
    ...
    private OnClickListener mOneShotListener = new OnClickListener() {
        public void onClick(View v) {
            ...
            mToast = Toast.makeText(AlarmController.this, "Alarm Title...", Toast.LENGTH_LONG);
            mToast.show();
        }
    };
